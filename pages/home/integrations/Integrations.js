        ...
        <div className="container" id="integration">
            <div>
                ...
                <div className="button-wrapper" style={{textAlign: 'center', marginTop: 30, paddingBottom: 80}}>
                    <a style={{marginTop: 10, cursor: 'pointer'}} className="btn-contained-lg page-scroll" href="https://demo.outerbridge.io/canvas" target="_blank">View All Integrations</a>
                </div>
            </div>
        </div>
